					...
					<tbody class="align-middle">
						<c:forEach var="item" items="${cartItems.getItems() }">
							<tr>
								...
								<td class="align-middle">${item.get("product").price }VND</td>
								...
								<td class="align-middle">${Double.valueOf(item.get("product").price) * Integer.valueOf(item.get("quantity")) }VND</td>
				...
				<div class="card border-secondary mb-5">
					...
					<div class="card-body">
						<div class="d-flex justify-content-between mb-3 pt-1">
							...
							<h6 class="font-weight-medium">${cartItems.getTotal2() }VND</h6>
						</div>
					</div>
					<div class="card-footer border-secondary bg-transparent">
						...
						%>
						<a class="btn btn-block btn-primary my-3 py-3" href="/cart/checkout">Proceed To
							Checkout</a>
						<%
						}
						%>
